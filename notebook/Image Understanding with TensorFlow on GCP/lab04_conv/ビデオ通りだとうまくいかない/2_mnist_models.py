...
#いろんなことがビデオと異なりすぎるのでここで一旦止める。tfを利用したバージョンが合ったのでそちらで試す。
...
get_ipython().system('echo "tensorboard --logdir $JOB_DIR"')
